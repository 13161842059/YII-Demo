...
use singer\library\jsonResponse\JsonResponse;
use singer\middlewares\MiddlewareImp;
use singer\middlewares\MidException;
...
class MyController extends Controller
{
    ...
    protected function _doFunction($param, $jsonp = false, $callback = 'callback')
    {
        ...
        $className = "\\singer\\models\\".$module."\\service\\".$controller."\\".ucfirst($action);
...
//        return new JsonResponse($res,200);
    ...
    public function middleware()
    {
        ...
        {
            $className = "singer\\middlewares\\".ucfirst($middleware);
